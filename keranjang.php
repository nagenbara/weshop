<?php
	...
	if($totalBarang == 0){
		echo "<h1> Anda belum menambahkan apapun ke keranjang</h1>";
	} else {
		...
		echo "<table class='table-list'>
				<tr class='baris-title'>
					...
					<th class='tengah'>Jumlah Barang</th>
		...
		echo "<div id='frame-button-keranjang'>
				...
				<a id='lanjut-belanja' href='".BASE_URL."index.php'>
				Lanjut Belanja
				</a>
				
				<a id='lanjut-pemesanan' href='".BASE_URL."index.php?page=data_pemesan'>
				Lanjut Pemesanan
				</a>
